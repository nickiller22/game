...
namespace games
{
    public partial class Form1 : Form
    {
        ...
        class loc
        {
            ...
            {
                //Сначала отключаем видимость у всех кнопок
                (Application.OpenForms[0] as Form1).button1.Visible = false;
                (Application.OpenForms[0] as Form1).btn_home.Visible = false;
                ...
                //Включаем кнопки в зависимости от видимости
                if (location == "Дом")
                {
                    (Application.OpenForms[0] as Form1).webBrowser1.Navigate(Environment.CurrentDirectory + "\\dialogs\\home\\home.html");
                    (Application.OpenForms[0] as Form1).btn_home.Visible = true;
                ...
                if (location == "Дом - Кухня")
                {
                    global_location = "Дом - Кухня";
        ...
        {
            loc locations = new loc();
            locations.show("Дом - Кухня");
        }
        ...
        private void btn_home_out_Click(object sender, EventArgs e)
        {
